...
"""
prints = sf.get_all_printings("voja jaws of the conclave")
sf.print_all_printings(prints)
...
"""
Searches for all printings of exact card
"""
printings = sf.get_all_printings("Wilhelt, the Rotcleaver")

"""
Grabs foil's most expensive
"""
exp_foil = sf.most_expensive_printing(printings, price_type='price_usd_foil')
print(exp_foil)

"""
Grabs nonfoil's most expensive
"""
exp_nonfoil = sf.most_expensive_printing(printings)
print(exp_nonfoil)

"""
Grabs foil's cheapest
"""
cheap_foil = sf.cheapest_printing(printings, price_type='price_usd_foil')
print(cheap_foil)

"""
Grabs nonfoil's cheapest
"""
cheap_nonfoil = sf.cheapest_printing(printings)
print(cheap_nonfoil)
...
"""
Random card from a filtered pool
"""
card = sf.get_random_card("t:dragon")
print(card)
card = sf.get_random_card("f:commander r:mythic")
print(card)
card = sf.get_random_card("c:green t:creature cmc<=3")
print(card)

"""
Searches for cards by set instead of by name like search_cards
"""
cards_by_set = sf.search_cards_by_set("mom")
